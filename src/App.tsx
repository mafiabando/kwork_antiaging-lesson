    ...
    <div className="page">
      ...
      <section className="section-white section">
        ...
        <p className="section-text">
          За 2 часа вы узнаете, как работают ключевые механизмы старения и что можно сделать, чтобы сохранить молодость и здоровье надолго.<br />
          Всё основано на доказательной медицине, простым языком, с реальными примерами из практики.
        </p>
      ...
      <section className="section-author section">
        ...
        <div className="author-content">
          <div className="author-text">
            <p>
              Евгения Владимировна Гальченко — врач-гинеколог, эндокринолог, 30 лет опыта, более 10 000 пациенток.<br />
              Автор курсов и видеоуроков для женщин о здоровье, гормонах и молодости
            </p>
          </div>
      ...
      <section className="section-white section">
        ...
        <p className="small-text">После оплаты вы получите ссылку и сможете смотреть урок в любое время.</p>
      ...
      <section className="section-light section">
        ...
        <p className="gift-text">
          Вместе с уроком вы получите чек-лист препаратов и добавок, которые помогают продлить молодость.<br />
